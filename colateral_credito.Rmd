...
consulta <- paste0(
  ...
  " COUNT(*) AS N_REG",
  " FROM ", tabla, " ",
  " WHERE (CAST(FECHA_INFORMACION AS DATE) - CAST(FECHA_INICIAL_DEL_CREDITO AS DATE)) < 90",
  " GROUP BY FECHA_INFORMACION"
)
...
consulta <- paste0(
  "SELECT ",
  "CASE WHEN (CAST(FECHA_INFORMACION AS DATE) - CAST(FECHA_INICIAL_DEL_CREDITO AS DATE)) < 90 THEN 'NUEVO' ELSE 'RECURRENTE' END AS TIPO_ACREDITADO, ",
