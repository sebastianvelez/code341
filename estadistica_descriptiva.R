...
consulta <- paste0(
  "SELECT (IDENTIFICACION_DEUDOR || '_' || FECHA_INICIAL_DEL_CREDITO || '_' ENTIDAD_CODIGO_SUPER),",
  " COUNT(*) AS N_REG,",
  ...
  " FROM ", tabla,
  " GROUP BY (IDENTIFICACION_DEUDOR || '_' || FECHA_INICIAL_DEL_CREDITO || '_' ENTIDAD_CODIGO_SUPER)"
)
